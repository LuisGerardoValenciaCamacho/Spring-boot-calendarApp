...
public class ConfigurationSecurity {
	...
	SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		return http.authorizeHttpRequests(authorizeRequest -> { authorizeRequest
			.requestMatchers(HttpMethod.GET, "/api/user/all").hasAnyRole("ADMIN")
			.requestMatchers(HttpMethod.GET, "/api/user/{id}").hasAnyRole("ADMIN")
			...
			.requestMatchers(HttpMethod.GET, "/api/event/all").hasAnyRole("ADMIN")
			.requestMatchers(HttpMethod.GET, "/api/event/{id}").hasAnyRole("ADMIN")
			.requestMatchers(HttpMethod.POST, "/api/event/create").hasRole("ADMIN")
			.requestMatchers(HttpMethod.PUT, "/api/event/update/{id}").hasRole("ADMIN")
			.requestMatchers(HttpMethod.DELETE, "/api/event/delete/{id}").hasRole("ADMIN")
